...
// Stop ends the sweeper goroutine. Nil-safe and idempotent-safe to call once
// at process shutdown; constructing a Limiter without Stopping it leaks the
// sweeper goroutine + ticker (harmless for a process-lifetime singleton, a
